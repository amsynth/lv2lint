...
* [lv2lint-0.12.0.zip](https://dl.open-music-kontrollers.ch/lv2lint/stable/lv2lint-0.12.0.zip) ([sig](https://dl.open-music-kontrollers.ch/lv2lint/stable/lv2lint-0.12.0.zip.sig))
...
* [lv2lint-0.12.0.tar.xz](https://git.open-music-kontrollers.ch/lv2/lv2lint/snapshot/lv2lint-0.12.0.tar.xz)([sig](https://git.open-music-kontrollers.ch/lv2/lv2lint/snapshot/lv2lint-0.12.0.tar.xz.asc))
